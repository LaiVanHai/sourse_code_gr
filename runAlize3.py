...
# #---------------------------------
# phan theo the loai
os.system("python getTime.py -c StartTest -o ./rpt/rpt4") # danh thoi gian bat dau
os.system("python createTestCH_QH.py -i ./lbl/lbl4 -o ./test/test4 -n ./ndx"); # tao file test
os.system("python ComputeTest_part.py -i ./test/test4 -o ./res/res4"); # test
# sua file targetTest_part
os.system("python report.py -i ./res/res4 -o ./rpt/rpt4"); # tao file bao cao

# ---------------------------------
# phan theo lan dieu
os.system("python createTest3.py -c ./test_ch/test_ch4 -q ./test_qh/test_qh4 -r ./res/res4 -p ./rpt/rpt4"); # tao file test
os.system("python ComputeTest2_part.py -c ./test_ch/test_ch4 -q ./test_qh/test_qh4 -a ./res_ch/res_ch4 -b res_qh/res_qh4"); # test
# sua file targetTest_ch_part va targetTest_qh_part
os.system("python report2.py -c ./res_ch/res_ch4 -q ./res_qh/res_qh4 -o ./rpt/rpt4"); # tao file bao cao

os.system("python exportData1.py -i ./rpt/rpt4 -f report.txt")
os.system("python exportData2.py -i ./rpt/rpt4 -f report_ch.txt")
os.system("python exportData2.py -i ./rpt/rpt4 -f report_qh.txt")

os.system("python getTime.py -c EndTest -o ./rpt/rpt4") # danh thoi gian ket thuc